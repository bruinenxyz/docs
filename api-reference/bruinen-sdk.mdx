...
The SDK is currently only available in Javascript and is written 100% in Typescript.
It is available as both a browser script and a Node.js SDK.
...
<Warning>
Without Bruinen Connect, users will not be able to reuse connections previously made with Bruinen, possibly adding additional steps for the user to complete authentication
</Warning>
...
const githubAccount = _.filter(userAccounts, account => account.source === "github");
